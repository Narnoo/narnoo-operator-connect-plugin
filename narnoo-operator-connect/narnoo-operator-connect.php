...
require_once( NARNOO_OPERATOR_CONNECT_PLUGIN_PATH . 'libs/narnooauthn.php' );
require_once( NARNOO_OPERATOR_CONNECT_PLUGIN_PATH . 'libs/narnooapi.php' );
...
class Narnoo_Operator_Connect {
	...
	**/
	function create_menu(){	
		...
		add_action( 'init', array( 'Narnoo_Connect_Following_Table', 'add_screen_options' ) );
